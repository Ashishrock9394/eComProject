<section class="product_section layout_padding">
   <div class="container">
      ...
      <div class="row">
         ...
         <div class="col-sm-6 col-md-4 col-lg-4 mb-4">  <!-- Each card takes 1/3rd width on large screens -->
            <div class="box">
               <div class="option_container">
                  <div class="options">
                  <a href="{{ route('show.product', $product->id) }}" class="option1">Show Description</a>
